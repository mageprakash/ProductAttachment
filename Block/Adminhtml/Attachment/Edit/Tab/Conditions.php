 ...
 */
namespace MagePrakash\ProductAttachment\Block\Adminhtml\Attachment\Edit\Tab;
...
class Conditions extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('mageprakash_productattachment_attachment');
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'mageprakash_productattachment_attachment_form')
    {
        /** @var \Magento\Framework\Data\Form $form */
