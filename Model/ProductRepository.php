...
use MagePrakash\ProductAttachment\Api\ProductRepositoryInterface;
use MagePrakash\ProductAttachment\Api\Data\ProductSearchResultsInterfaceFactory;
...
use MagePrakash\ProductAttachment\Model\ResourceModel\Product as ResourceProduct;
use MagePrakash\ProductAttachment\Model\ResourceModel\Product\CollectionFactory as ProductCollectionFactory;
...
class ProductRepository implements ProductRepositoryInterface
{
    ...
    public function save(
        ...
        $productData = $this->extensibleDataObjectConverter->toNestedArray(
            $product,
            [],
            \MagePrakash\ProductAttachment\Api\Data\ProductInterface::class
        );
